...
export const English: Messages = {
  ...
  help31: `Disclaimer: Globle Unlimited was made purely for fun with no intention of monetization. A link to the license this game is shared under can be found here: `,
  help3: `Normally, a new mystery country would be available everyday. However, this is Globle Unlimited! The name really says it all, you can continue to play the awesome game that is Globle as long as you'd like. Absolutely no credit for this game should go to me, I simply changed a few lines of code to allow for endless fun. Consider buying the original creator of Globle a coffee below!`,
  France: "France",
  Nepal: "Nepal",
  Mongolia: "Mongolia",
  ...
  Footer1: "Checkout the original creator of Globle: The Abe Train",
  Footer2: "Enjoying the game?",
  Footer3: "Buy the original creator of Globle a coffee",
  Loading: "Loading...",
  FAQTitle: "FAQ",
